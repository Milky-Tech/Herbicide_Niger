...
-->
  ...
  <body>
    ...
    <!-- Page Content -->
    <div class="page-heading about-heading header-text" style="height: 200px; backgroud-size:contain;background-image: url(assets/images/annual-grass.jpg);">
      <div class="container">
        <div class="row">
          <div class="col-md-12" >
            ...
            <div class="down-content" style="border-radius: 0px;">
                  ...
                  display: block; height:50px; margin:20px auto;width:35vw; text-align: center;" class="filled-button">Annual Grass</h1>
                </div>
          </div>
          </div>
        </div>
...
<div class="container">                             
 ...
 <?php
    ...
    if ($arrweed[$i]!=="None"&&"No"):?>
    <tr id="click" onClick="display_info()"><td><div>
   <p style="font-family:cursive;"><?php echo $product['name'].'<br>';?></p></div>
    </td>
    <td>
...
<script>
          ...
          function display_info(){
             ...
             <?php foreach ($products as $product):?><?php    
                ...
                if ($arrweed[$i]!=="None"&&"No"):?>
             Active ingredient: <?php echo $product['ingredients'].'<br>'; ?>
              ...
              click.innerHTML= info;
          }
          // click.addEventListener("onClick", display_info)
      </script>
