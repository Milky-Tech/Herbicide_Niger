...
-->
  ...
  <body>
    ...
    <!-- Page Content -->
    <div class="page-heading about-heading header-text" style="height: 200px;background-image: url(assets/images/sedges.jpg);">
      <div class="container">
        <div class="row">
          <div class="col-md-12" >
            ...
            <div class="down-content" style="border-radius: 0px;">
                  ...
                  display: block; height:50px; margin:20px auto;width:35vw; text-align: center;" class="filled-button">Sedges</h1>
                </div>
          </div>
          </div>
        </div>
