...
-->
  ...
  <body>
    ...
    <!-- Page Content -->
    <div class="page-heading about-heading header-text" style="height: 200px;background-image: url(assets/images/annual-broad-leaf.jpg);">
      <div class="container">
        <div class="row">
          <div class="col-md-12" >
...
<div class="container">                             
 ...
 <?php
    ...
    if ($arrweed[$i]==="Annual Broadleaves"):?>
    <tr><td>
